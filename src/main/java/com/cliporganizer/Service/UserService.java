...
import com.cliporganizer.Repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public boolean createUser(com.cliporganizer.model.User user){
    ...
    public boolean existsWithUsername(String username){
        if(userRepository.findByUsername(username) instanceof com.cliporganizer.model.User){
            return true;
        }else{
            return false;
        }
    ...
    public boolean existsWithEmail(String email){
        if(userRepository.findByUsername(email) instanceof com.cliporganizer.model.User){
            return true;
        }else{
            return false;
        }
